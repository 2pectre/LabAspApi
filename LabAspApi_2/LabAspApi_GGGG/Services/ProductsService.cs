...
namespace LabAspApi.Services
{
    public class ProductsService
    {
        ...
        {
            new Product { Id = 1, Name = "LabAspApi_GGGG_Product1", Price = 10.0m },
            new Product { Id = 2, Name = "LabAspApi_GGGG_Product2", Price = 20.0m },
            new Product { Id = 3, Name = "LabAspApi_GGGG_Product3", Price = 30.0m }
        };
